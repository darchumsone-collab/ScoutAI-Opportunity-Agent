 ...
 */
object ApiConfig {
    // Current Host IP for real device connectivity
    // Change this to match your PC's local IP if it changes
    private const val HOST = "192.168.8.254"
...
object NetworkModule {
    ...
    @Provides
    @Singleton
    fun provideApiService(retrofit: Retrofit): ScoutApiService {
